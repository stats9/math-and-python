...
|:--------:|:--------:|:--------:|:--------:|:--------:|
| $`r round(ress[1], 4)`$  | $`r round(ress[2], 4)`$ | $`r ress[3]`$ | $`r round(ress[4], 4)`$ | $`r round(ress[5], 4)`$ | 
...
|:--------:|:--------:|:--------:|:--------:|
| $`r round(temp2$MEAN[1], 4)`$  | $`r round(temp2$Variance[1], 4)`$ | $`r round(temp2$MEAN[2], 4)`$ | $`r round(temp2$Variance[2], 4)`$ 
